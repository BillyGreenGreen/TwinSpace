...
public class SimpleCrosshair : MonoBehaviour
{
    ...
    {
        if (!PlayerPrefs.HasKey("CrosshairThickness")){
            PlayerPrefs.SetInt("CrosshairThickness", (int)(0.3 * 10));
            PlayerPrefs.SetInt("CrosshairGap", (int)(0.6 * 10));
            PlayerPrefs.SetInt("CrosshairSize", (int)(1.3 * 10));
            PlayerPrefs.SetInt("CrosshairR", 1);
            PlayerPrefs.SetInt("CrosshairG", 1);
            PlayerPrefs.SetInt("CrosshairB", 1);
        }
        m_crosshair.thickness = PlayerPrefs.GetInt("CrosshairThickness");
        m_crosshair.gap = PlayerPrefs.GetInt("CrosshairGap");
        m_crosshair.size = PlayerPrefs.GetInt("CrosshairSize");
        //m_crosshair.color = new Color(PlayerPrefs.GetInt("CrosshairR"), PlayerPrefs.GetInt("CrosshairG"), PlayerPrefs.GetInt("CrosshairB"));
